                    ...
                    <form id="<?php echo ($this->qus_data[0]->exam_folder_id * $i) ?>" class="oe-qustion_submit" action="" method="post">
                        ...
                        <div>
                            <span>
                                ...
                                <input <?php echo $this->published_exam ? "" : "disabled" ?> type="text" name="qus1" value="<?php echo $res[0]->a1 ?>">
                            ...
                            <span>
                                ...
                                <input <?php echo $this->published_exam ? "" : "disabled" ?> type="text" name="qus2" value="<?php echo $res[0]->a2 ?>">
                            ...
                            <span>
                                ...
                                <input <?php echo $this->published_exam ? "" : "disabled" ?> type="text" name="qus3" value="<?php echo $res[0]->a3 ?>">
                            ...
                            <span>
                                ...
                                <input <?php echo $this->published_exam ? "" : "disabled" ?> type="text" name="qus4" value="<?php echo $res[0]->a4 ?>">
                        ...
                        <section>
                            <span>
                                ...
                                <select <?php echo $this->published_exam ? "" : "disabled" ?> name="correct_ans" form="<?php echo ($this->qus_data[0]->exam_folder_id * $i) ?>">
                    ...
                    <form id="<?php echo ($this->qus_data[0]->exam_folder_id * $i) ?>" class="oe-qustion_submit" action="" method="post">
                        ...
                        <div>
                            <span>
                                ...
                                <input <?php echo $this->published_exam ? "" : "disabled" ?> type="text" name="qus1">
                                <input type="hidden" name="a1_id" value="<?php echo $i + 1 ?>">
                            </span>
                            <span>
                                <strong>
                                ...
                                <input <?php echo $this->published_exam ? "" : "disabled" ?> type="text" name="qus2">
                                <input type="hidden" name="a2_id" value="<?php echo $i + 2 ?>">
                            </span>
                            <span>
                                <strong>
                                ...
                                <input <?php echo $this->published_exam ? "" : "disabled" ?> type="text" name="qus3">
                                <input type="hidden" name="a3_id" value="<?php echo $i + 3 ?>">
                            </span>
                            <span>
                                <strong>
                                ...
                                <input <?php echo $this->published_exam ? "" : "disabled" ?> type="text" name="qus4">
                                <input type="hidden" name="a4_id" value="<?php echo $i + 4 ?>">
                            </span>
                        </div>
                        <section>
